...
import { loadCriacaoPage, loadColaboracaoPage, loadInterpretacaoPage, loadProject } from '@/sanity/loader/loadQuery'
...
export default async function DynamicPersonalPage({ params }: { params: { slug: string } }) {
  const { slug } = params
