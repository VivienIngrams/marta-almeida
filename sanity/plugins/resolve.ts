...
export const locations = {
  ...
  project: defineLocations({
    select: { titleEn: 'title.en', titlePt: 'title.pt', slug: 'slug.current' },
    resolve: (doc) => ({
      message: 'This is your project page. When edited do not forget to publish your changes',
      tone: 'positive',
      locations: [
        {
          title: (doc?.titleEn as string | undefined) || (doc?.titlePt as string | undefined) || 'Untitled',
