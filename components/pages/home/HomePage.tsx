...
export function HomePage({ data, language }: HomePageProps) {
  ...
  return (
    ...
    >
      <div className="py-10  lg:px-6  lg:pr-8 lg:pt-16 xl:pt-20  px-4 lg:pl-80 2xl:pl-96">
      <div
        className="
      ...
      >
        <Link href="/bio" className="w-full h-full flex flex-col lg:flex-1 justify-center">
          {/* Home image for desktop/tablet */}
            ...
            {overviewText && (
              <div className="mt-2 text-base md:text-lg 2xl:text-xl text-black text-right max-w-[95%] ml-auto cursor-pointer">
